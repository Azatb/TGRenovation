...
public class ContactPersonRepository implements ICrud<ContactPerson> {
    ...
    public void update(ContactPerson contactPerson) {
        jdbc.update("UPDATE renovationdb.contact_person SET name = '" + contactPerson.getName() + "', number = '" + contactPerson.getNumber() + "' pickupAdress = '" + contactPerson.getPickupAdress() + "', fk_CVR = '" +
